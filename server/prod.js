...
const dt = __webpack_require__(18);
...
const passportLocalMongoose = __webpack_require__(57);
...
exports.Logger = __webpack_require__(58);
var Handler;
(function (Handler) {
    /**
...
app.use('/api', __webpack_require__(60));
app.use('/api/user', __webpack_require__(61));
app.use('/', __webpack_require__(63));
...
module.exports = app => {
    if (app.get('env') === 'production') {
        ...
        const { renderModuleFactory } = __webpack_require__(5);
...
module.exports = require("data.task");
...
var map = {
	"./main.5ca631dc8d4a19f3401e.bundle.js": 21
};
...
const files_1 = __webpack_require__(2);
const path = __webpack_require__(3);
const morgan = __webpack_require__(45);
const bodyParser = __webpack_require__(46);
const favicon = __webpack_require__(47);
const compression = __webpack_require__(48);
const x_frame = __webpack_require__(49);
const connect_flash = __webpack_require__(50);
module.exports = app => {
...
const session = __webpack_require__(52);
const Redis = __webpack_require__(53)(session);
module.exports = app => {
...
const mongoose = __webpack_require__(8);
const autoIncrement = __webpack_require__(55);
module.exports = (app) => {
...
const LocalStrategy = __webpack_require__(59).Strategy;
module.exports = app => {
    /**
     * Init Passport
     */
...
Object.defineProperty(exports, "__esModule", { value: true });
const express = __webpack_require__(0);
const user_ctrl_1 = __webpack_require__(62);
const router = express.Router();
...
Object.defineProperty(exports, "__esModule", { value: true });
const files_1 = __webpack_require__(2);
const gzipStatic = __webpack_require__(64);
...
const cluster = __webpack_require__(67);
const debug = __webpack_require__(68)('www.deskvibe.co:server');
module.exports = app => {
    console.log('Initializing Server');
    const port = utils_1.Utils.normalizePort(process.env.PORT || config_1.Config.port || '3000');
    const server = http.createServer(app);
    const numCPUs = process.env.WEB_CONCURRENCY || __webpack_require__(69).cpus().length;
    app.set('port', port);
    /**
